...
for (i = 0; i < fLen; i++) {
	if (grossmargin_data[i] > bm_data [i] ) {color_data.push({y:grossmargin_data[i].value,color: "#44cf3a".value});} 
	else if (grossmargin_data[i] < bm_data [i] ) {color_data.push({y:grossmargin_data[i].value,color: "#cf0f14".value});} 
	else {color_data.push({y:grossmargin_data[i].value,color: "#f3ff4a".value});} 
}
